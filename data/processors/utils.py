...
class InputFeatures:
    ...
    Args:
        ...
        global_attention_mask: Mask to set local or global attention for Longformer.
            The user can define which tokens attend "locally" and which tokens attend "globally" 
            by setting the tensor global_attention_mask at run-time appropriately. 
            Longformer employs the following logic for global_attention_mask: 
                0 - the token attends "locally", 
                1 - token attends "globally". 
    ...
    global_attention_mask: Optional[List[int]] = None
