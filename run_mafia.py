...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, MafiaDataTrainingArguments, TrainingArguments))
    ...
    test_dataset = MafiascumDataset(data_args, tokenizer=tokenizer, mode="test") if training_args.do_predict else None
